...
export const GroupsSettlementPlanResponseSchema = z
  .array(
    z.object({
...
export type SettlementPlanResponse = z.infer<
  typeof GroupsSettlementPlanResponseSchema
>;

// Backward-compatible alias for contracts expecting this name
export const SettlementPlanResponseSchema = GroupsSettlementPlanResponseSchema;
