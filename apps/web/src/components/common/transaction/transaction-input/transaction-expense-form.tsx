...
import {
  useAccountTypeOutgoing,
  usegetAllAccounts,
} from "@/api/transaction-accounts/getSpecialAccounts";
...
export const TransactionExpenseForm = () => {
  ...
  const { data: outgoingAcc } = useAccountTypeOutgoing();
  const { data: allAccounts } = usegetAllAccounts();
